...
public class HomeItemsActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbUtils.Open();
        Cursor cursor = mDbUtils.getWordsByCategory(HOME_OBJECTS);
