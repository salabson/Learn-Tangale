...
public class HumanBodyActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbUtils.Open();
        Cursor cursor = mDbUtils.getWordsByCategory(HUMAN_BODY);
